...
type = {k: re.compile(v) for k, v in {
    ...
    'usbstick': r'\b(?:micro)?usb|\b(?:(?:jump|pen)?drive|cruzer|attache|transmemory|data ?traveler|micro vault|basic line|hxs\d?|usm-?\d{1,3}(?:g(?:u|t|r|qx|mp)|w3|ca1|x|sa1|m))\b',
    'phone': r'\b(?:sim|lte)\b',
    'tv': r'\btv\b',
