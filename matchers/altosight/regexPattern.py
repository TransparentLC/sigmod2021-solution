...
type = {k: re.compile(v) for k, v in {
    'sdcard': r'(?:\b(?:(?:micro ?)?sd(?:[hx]c)?|secure digital|uhs(?: class)?|exceria|sf-?(?:\d{1,3}n4|[gm]\d{1,3}t|[em]\d{1,3})|sr-?\d{1,3}(?:ux2[ab]|uy[23]?a|[hu]xa|a[41](?: ?[pv])?)|sf-?(?:\d{1,3}(?:[un][41]|nx|ux(?:2b?)?|uy[23]?|b[f4])|g\d{1,3})|sn-?(?:bb\d{1,3}|ba\d{1,3} ?f?))\b)|\bevo\+ ',
